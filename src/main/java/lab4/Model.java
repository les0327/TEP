...
public class Model {
    ...
    private void kohren() {
        ...
        double[] kohren4 = {9.065, 7.679,6.841, 6.287, 5.892, 5.598, 5.365, 5.175, 5.017, 4.884, 4.366, 3.720, 3.093, 2.500};
        double[] kohren8 = {6.798, 5.157, 4.377, 3.910, 3.595, 3.362, 3.185, 3.043, 2.926, 2.829, 2.462, 2.022, 1.616, 1.250};
